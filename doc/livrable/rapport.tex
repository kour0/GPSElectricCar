...
les arbres. Cependant, nous avons réalisé que cette structure ne convenait pas à notre cas d'utilisation, car elle 
ne permettait pas de représenter efficacement toutes les connexions entre toutes les stations. 
...
Ainsi, la représentation ci-dessous, est une représentation graphique simplifiée de la structuration de notre graphe. A, B, C et D sont des 
...
Afin de faciliter l'instanciation du graphe, nous avons également mis en place une solution pour la création des arêtes du graph. En effet, la création des arêtes du graph est une opération coûteuse en temps, et nous avons donc décidé de la paralléliser. Pour cela, nous avons réalisé ces 2 structures additionnelles :
...
\subsection{Triangle délai-qualité-coût}
...
On peut ainsi remarquer que notre projet présente de nombreux points forts notamment grâce aux connaissances acquises lors des cours de Télécom Nancy. Cependant, plusieurs facteurs internes constituent nos faiblesses
 ...
 celle de pouvoir demander de l'aide aux professeurs, ou encore le fait que les salles soient ouvertes et à notre disposition pour
